...
const RegisterForm = () => {
    ...
    return (
        <>
            <section className="bg-primary py-3 py-md-5 py-xl-2">
                                ...
                                <div className="card-body p-3 p-md-4 p-xl-4">
                                    <div className="row">
                                        <div className="col-12">
                                            <div className="mb-4">
                                                <h3>Register</h3>
                                                <p>I have also an account? <Link to={'/login'} href="#!">Login</Link></p>
                                            </div>
                                        </div>
                                    </div>
                                    <form action="#!">
                                        <div className="row gy-3 overflow-hidden">
                                            ...
                                            <div className="col-12">
                                                <div className="form-floating mb-3">
                                                    <input type="password" className="form-control" name="password2" id="password2" value="" placeholder="Confrom Password" required />
                                                    <label for="password2" className="form-label">Confrom Password</label>
                                                </div>
                                            </div>
                        ...
                        <div className="col-12 col-md-6 col-xl-7">
                            <div className="d-flex justify-content-center text-bg-primary">
                                <div className="col-12 col-xl-9">
                                    ...
                                    <h2 className="h1 mb-4">Please register an account with Google</h2>
                                    <p className="lead mb-5">Google Authenticator is a project developed by Google to provide an extra layer of security for online accounts.</p>
