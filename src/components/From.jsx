                    ...
                    <div className="row gy-4 align-items-center">
                        <div className="col-12 col-md-6 col-xl-7">
                            <div className="d-flex justify-content-center text-bg-primary">
                                <div className="col-12 col-xl-9">
                                    ...
                                    <h2 className="h1 mb-4">Support for login from Google only, so try</h2>
                        ...
                        <div className="col-12 col-md-6 col-xl-5">
                            <div className="card border-0 rounded-4">
                                <div className="card-body p-3 p-md-2 p-xl-4">
                                    <div className="row">
                                        <div className="col-12">
                                            <div className="mb-4">
                                                <h3>Sign in</h3>
                                                <p>Don't have an account? <Link to={'/register'} href="#!">Sign up</Link></p>
                                            </div>
                                        </div>
                                    </div>
                                    <form action="#!">
                                    ...
                                    <div className="row">
                                        <div className="col-12">
                                            ...
                                            <div className="d-flex gap-2 gap-sm-3 justify-content-centerX">
                                                ...
                                                <a type='submit' className="btn btn-outline-danger bsb-btn-circle bsb-btn-circle-2xl" onClick={loginwithGoogle} >
